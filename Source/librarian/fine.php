                                       ...
                                       <tbody>
                                           <?php
                                                ...
                                                while ($row=mysqli_fetch_array($res)) {
													...
													?>
                                                    <ul>
                                                        <li><a href="delete-fine.php?id=<?php echo $row["id"]; ?> " style="color: red"><i class="fas fa-trash"></i></a></li>
                                                        <li><a href="edit-fine.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-edit"></i></a></li>
                                                    </ul>
                                                    <?php
                                                    echo "</td>";
                                                    echo "</tr>";
