                ...
                <div class="details">
                    ...
                    <form method="post">
                        ...
                        <div class="text-right mt-20">
                            <input type="submit" value="Save" class="btn btn btn-success" name="update">
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="col-md-3">
                            <div class="photo">
                                ...
                                while ($row = mysqli_fetch_array($res)) {
                                    ?><img src="<?php echo $row["photo"]; ?>" alt="Profile Photo" class="img-fluid"> <?php
                                }
                                ?>
                            </div>
                            <div class="uploadPhoto">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="gap-30"></div>
                                    <input type="submit" class="btn btn btn-success" value="Upload Image" name="submit">
                                </form>
                            </div>
                            <?php 
