                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="right text-right">
                            ...
                            <span class="disabled">Send to student</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-lg border-info">
                    <div class="card-header bg-info text-white text-center">
                        <h5 class="mb-0">🎓 Send Message to Student</h5>
                    </div>
                                ...
                                <select name="rusername" class="form-control border-info">
                                    <?php 
                                        ...
                                        while ($row = mysqli_fetch_array($res)) {
                                            echo "<option value='{$row["username"]}'>{$row["username"]} ({$row["regno"]})</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                    ...
                    <div class="card-footer text-center text-muted small">
                        Messages are sent securely to the student's inbox.
                    </div>
                </div>
            </div>
        </div>
