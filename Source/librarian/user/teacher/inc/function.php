<?php
	if (isset($_POST["submit"])) {
		...
		elseif(strlen($password) > 16 ){
            ...
            $insert = mysqli_query($link, "insert into t_registration values('','$name','$username','$hashed_password','$lecturer','$email','$phone','$idno','$address','$utype','$photo','pending','$vkey','no')");
            if($insert){
                $to = "$email";
