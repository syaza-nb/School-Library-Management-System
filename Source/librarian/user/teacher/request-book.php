...
// Fetch teacher info
$userQuery = mysqli_query($link, "SELECT * FROM t_registration WHERE username = '{$_SESSION['teacher']}'");
...
if (isset($_POST["submit"])) {
    ...
    if ($bname === "" || $burl === "") {
        ...
        if ($stmt->execute()) {
            $message = "<div class='alert alert-success'><strong>Success:</strong> Book request submitted successfully.</div>";
        } else {
