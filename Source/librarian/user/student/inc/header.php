...
<!--                                <li><a href="notifications.php">Messages</a></li>-->
    					...
    					<li class="menu <?php if($page=='bookr&c'){ echo 'active';} ?>">
      						<a href="rate_book.php"><i class="fas fa-book"></i>Book Rating</a>
    					</li>
    					<li class="menu <?php if($page=='helpdesk'){ echo 'active';} ?>">
      						<a href="helpdesk.php"><i class="fas fa-book"></i>Helpdesk</a>
    					</li>	                    
    				</ul>
				</div>
			</div>
