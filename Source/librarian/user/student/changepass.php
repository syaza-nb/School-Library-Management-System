				...
				<div class="row">
					<div class="col-md-12">
						<form action="" class="pass-content" method="post">
							...
							<input type="password" class="form-control mt-10" name="cpassword" placeholder="Current password" style="border-color: green;">
							<br>
							<b>New Password:</b>
							<input type="password" class="form-control mt-10" name="npassword" placeholder="New password" style="border-color: green;">
							<br>
							<b>Conform Password:</b>
							<input type="password" class="form-control mt-10" name="conpass" placeholder="Conform password" style="border-color: green;">
							<br>
							<input type="submit" name="submit" class="btn btn btn-success" value="Change Password" style="background-color: green;">
						</form>
						  <?php
