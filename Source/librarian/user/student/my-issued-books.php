						...
						<div class="st-issuedBook">
							<table id="dtBasicExample" class="table table-dark table-striped text-center">
								...
								<?php 
									...
									// $res= mysqli_query($link, "SELECT ib.regno, ib.username, ib.booksname, ib.booksissuedate, ib.booksreturndate, 
                                    //     IFNULL(fz.fine, '0') AS fine,
                                    //     fz.id AS finezone_id
                                    //     FROM issue_book ib
                                    //     LEFT JOIN finezone fz ON ib.id = fz.id
                                    //     WHERE ib.username = '{$_SESSION['student']}'
                                    //     ORDER BY ib.id DESC");
