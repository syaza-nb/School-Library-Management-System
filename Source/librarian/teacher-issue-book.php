								...
								<form action="" class="form-control" method="post" name="idn">
									<table class="table">
										<tr>
											...
											<td>
												<input type="submit" class="btn btn btn-success" value="select" name="submit1">
											</td>
										</tr>
									</table>
                                    <?php 
									...
									<table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                               <input type="submit" name="submit2" class="btn btn-sm btn-success" value="Issue Book"> 
                                            </td>
                                        </tr>
                                    </table>
                                  <?php
