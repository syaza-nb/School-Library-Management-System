	                ...
	                <ul>
	                   ...
	                   <li class="menu menu-toggle1">
    					...
    					<li class="menu menu-toggle3">
    					 ...
    					 <li class="menu <?php if($page=='fine'){ echo 'active';} ?>">
      						<a href="fine.php"><i class="fas fa-dollar-sign"></i>Fine</a>
    					</li>
    					 <li class="menu <?php if($page=='status'){ echo 'active';} ?>">
      						<a href="status.php"><i class="fab fa-staylinked"></i>User Status</a>
    					</li>
    					...
    					<li class="menu <?php if($page=='helpdesk'){ echo 'active';} ?>">
    						<a href="admin_helpdesk.php"><i class="bi bi-info-circle-fill" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
    							<path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2"/>
    						</svg></i>view helpdesk</a>
    					</li>
    					<li class="menu <?php if($page=='activity_logs'){ echo 'active';} ?>">
      						<a href="activity_logs.php"><i class="fas fa-book"></i>view Activity Logs</a>
    					</li>
    					<li class="menu <?php if($page=='reports'){ echo 'active';} ?>">
      						<a href="generate_report.php"><i class="fas fa-book"></i>Generate Reports</a>
    					</li>
    				</ul>
				</div>
			</div>
