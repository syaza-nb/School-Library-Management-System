...
//            }
        ...
        elseif(mysqli_num_rows($sql_e) > 0){
		    ...
		    $insert = mysqli_query($link, "insert into lib_registration values('','$name','$username','$password','$email','$phone','$sem','$dept','$session','$regno','$address','$utype','$photo','pending','$vkey','no')");
            if($insert){
                $to = "$email";
