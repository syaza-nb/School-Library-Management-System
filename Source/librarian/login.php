...
<div class="login">
  ...
  <div class="login-content">
    <div class="login-body">
      <h4 class="text-center">Librarian Login Form</h4>
      ...
      if (isset($_POST["login"])) {
        $res = mysqli_query($link, "SELECT * FROM lib_registration WHERE username='$_POST[username]' AND password='$_POST[password]'");
